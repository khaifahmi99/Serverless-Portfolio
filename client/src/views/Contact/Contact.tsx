                ...
                <div className='w-full lg:w-1/2'>
                    ...
                    <div className='font-bold'>
                        ...
                        <span className="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 relative inline-block">
                            <span className="relative text-white hover:underline italic">shoot me an email</span>
                        </span>
                        <span className='pl-2'>at user@example.com. I can also be reached via these platform, so let's start connecting!</span>
                    </div>
